...
RSpec.describe ObjectivesController, type: :controller do
  ...
  describe "GET #show" do
    it "assigns the requested objective as @objective" do
      objective = Objective.create! valid_attributes
      get :show, params: {id: objective.to_param}, session: valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested objective as @objective" do
      objective = Objective.create! valid_attributes
      get :edit, params: {id: objective.to_param}, session: valid_session
      expect(assigns(:objective)).to eq(objective)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Objective" do
        expect {
          post :create, params: {objective: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved objective as @objective" do
        post :create, params: {objective: invalid_attributes}, session: valid_session
        expect(assigns(:objective)).to be_a_new(Objective)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested objective" do
        objective = Objective.create! valid_attributes
        put :update, params: {id: objective.to_param, objective: new_attributes}, session: valid_session
        objective.reload
      ...
      it "assigns the requested objective as @objective" do
        objective = Objective.create! valid_attributes
        put :update, params: {id: objective.to_param, objective: valid_attributes}, session: valid_session
        expect(assigns(:objective)).to eq(objective)
      end
    ...
    context "with invalid params" do
      it "assigns the objective as @objective" do
        objective = Objective.create! valid_attributes
        put :update, params: {id: objective.to_param, objective: invalid_attributes}, session: valid_session
        expect(assigns(:objective)).to eq(objective)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested objective" do
      objective = Objective.create! valid_attributes
      expect {
        delete :destroy, params: {id: objective.to_param}, session: valid_session
      }.to change(Objective, :count).by(-1)
    end
