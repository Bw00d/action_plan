class Cover < ApplicationRecord
  ...
  def set_blocks
      ...
      Block.create!(position: 3, content: self.plan.date.strftime('%B %d, %Y'), font_size: 'h2', font_weight: 'bold', 
                    text_align: 'center',bottom_padding: '20px', cover_id: self.id)
      Block.create!(position: 4, content: '0700 - 2200 ', font_size: 'h2', font_weight: 'bold', 
                    text_align: 'center', bottom_padding: '25px', cover_id: self.id)
      Block.create(position: 5, content: 'ADD AN IMAGE', font_size: 'h2', font_weight: 'bold', 
                   text_align: 'center', bottom_padding: '50px', cover_id: self.id, image_block: true )
      Block.create!(position: 6, content: 'charge code', font_size: 'h3', font_weight: 'bold', 
